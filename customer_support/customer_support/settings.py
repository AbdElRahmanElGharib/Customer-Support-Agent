...
load_dotenv(Path.joinpath(REPO_DIR, '.env'))
...
SECRET_KEY = os.getenv('MAIN_DJANGO_SECRET_KEY')
...
SUBMISSIONS_CACHE_KEY = "submissions:list"
SUBMISSIONS_CACHE_TTL_SECONDS = 60
